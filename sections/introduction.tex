...
\end{itemize}
We analyze Reddit discussions from 2017--2019 using a quasi-experimental analysis, called the Difference-in-Difference (DiD)~\cite{abadie2005semiparametric} design with multiple control countries to isolate the effects of summit diplomacy.
